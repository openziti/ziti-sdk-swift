...
public class ZitiTunnel : NSObject, ZitiUnretained {
    ...
    public func v1Host(_ ziti_ctx: UnsafeRawPointer!, _ service_name: UnsafePointer<Int8>!, _ proto: UnsafePointer<Int8>!, _ hostname: UnsafePointer<Int8>!, _ port: Int32) -> Int32 {
        return ziti_tunneler_host_v1(tnlr_ctx, ziti_ctx, service_name, proto, hostname, port)
    }
    
    public func v1Intercept(_ ziti_ctx: UnsafeRawPointer!, _ service_id: UnsafePointer<Int8>!, _ service_name: UnsafePointer<Int8>!, _ hostname: UnsafePointer<Int8>!, _ port: Int32) -> Int32 {
        return ziti_tunneler_intercept_v1(tnlr_ctx, ziti_ctx, service_id, service_name, hostname, port)
    }
